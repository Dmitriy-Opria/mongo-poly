...
month_start = int(input('Enter Start Month in the format MM: '))
month_end = int(input('Enter End Month in the format MM: '))
...
for m in months:
    ...
    if len(month) <= 1:
        month = '0' + month
    download_url_weather = "{}{}{}{}{}{}{}{}{}".format(w_strng_1, year, month, w_strng_2, code_list[selected_ind], w_strng_3, year, month, w_strng_4)
    print(download_url_weather)
    urllib.request.urlretrieve(download_url_weather, 'C:\Flurosat\Modelling\Weather_download\Data\{}_{}_Data.csv'.format(year,month))
